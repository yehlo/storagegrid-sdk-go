...
type TenantPolicy struct {
	...
	AllowComplianceMode              *bool    `json:"allowComplianceMode,omitempty"`              // Whether a tenant can use compliance mode for object lock and retention. If omitted, it defaults to true if global object lock is enabled. Otherwise it defaults to false unless explicitly set to true.
